...
(1) Randomly select 100,000 SNPs based on information from SNP_Table.txt generated from Genome Studio, which is supposed to include at least three columns: SNP Name, Chr, Position. The information in SNP_Table.txt can be also retrieved from final report.
```sh
